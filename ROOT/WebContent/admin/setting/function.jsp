  ...
  <body data-spy="scroll" data-target=".subnav" data-offset-top="40">
		...
		<div id="navigation" class="navbar">
            <div class="navbar-innert">
	            ...
	            <a class="brand" href="#">模块功能 </a>
				<a class="brand2">编辑模块功能 </a>
            </div>
			...
			<!-- 开始显示form表单 -->
				<div class="form-actions">
					...
					<div class="form-inline">
						...
						<input id="functionname" name="functionname" type="text"  value="" class="small" />
					</div>
					<div class="form-inline">
					...
					<div class="form-inline">
						...
						<input id="visitmethodname" name="visitmethodname" type="text" value="" class="medium" />
						<span class="label label-info">当表单页需要控制元素访问权限时，请输入表单元素的id名称，以告诉系统需要对此页面的form做进一步的权限判定</span> 
					</div>
					<div class="form-inline">
