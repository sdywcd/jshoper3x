  ...
  <body data-spy="scroll" data-target=".subnav" data-offset-top="40">
		...
		<div id="navigation" class="navbar">
            <div class="navbar-innert">
	            ...
	            <a class="brand" href="#">系统模块</a>
				<a class="brand2">编辑系统模块</a>
            </div>
			...
			<!-- 开始显示form表单 -->
				<div class="form-actions">
					...
					<div class="form-inline">
						...
						<input id="modulename" name="modulename" type="text" value="" class="small" />
					</div>	
					<div class="form-inline">
    	...
    	<script type="text/javascript" src="<%=basePath%>admin/js/setting/modulementjs.js"></script>
