  ...
  <body data-spy="scroll" data-target=".subnav" data-offset-top="40">
    	...
    	<div class="container-fluid containerb">
			...
			<div class="line-dotted"></div>
				<!-- flexigrid -->
				<div id="flexsitenavigationmanagement">
    	...
    	<script type="text/javascript" src="<%=basePath%>admin/js/pagecontent/sitenavigationmentjs.js"></script>
