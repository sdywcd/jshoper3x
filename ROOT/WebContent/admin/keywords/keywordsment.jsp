...
<meta name="author" content="magi">
    <title>关键字设置 &middot; jshoper</title>
  ...
  <body data-spy="scroll" data-target=".subnav" data-offset-top="40">
		...
		<div class="navbar">
            <div class="navbar-innert">
	            ...
	            <a class="brand" href="#">关键字</a>
				<a class="brand2">所有关键字列表</a>
            </div>
    	...
    	<script type="text/javascript" src="<%=basePath%>admin/js/keywords/keywordsmentjs.js"></script>
