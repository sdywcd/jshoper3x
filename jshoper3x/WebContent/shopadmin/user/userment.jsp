...
<title>用户设置 &middot; jshoper</title>
...
<body data-spy="scroll" data-target=".subnav" data-offset-top="40">
	...
	<div class="navbar">
		<div class="navbar-innert">
			<a class="brand" href="#"><img
				...
				height="30" alt=""></a> <a class="brand" href="#">用户设置</a> <a
				class="brand2">所有管理类及运营类账户列表</a>
		</div>
	</div>
	<div class="container-fluid containerb">
		...
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<!-- flexigrid -->
				<div id="flexusermanagement">
					<table id="usermanagement" style="display: none;"></table>
				</div>
				<div class="line-dotted"></div>
				<!-- 提示框 -->
	...
	<script type="text/javascript"
		src="<%=basePath%>admin/shop/js/user/usermentjs.js"></script>
