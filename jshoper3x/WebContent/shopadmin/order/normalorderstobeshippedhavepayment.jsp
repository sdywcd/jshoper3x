...
<body data-spy="scroll" data-target=".subnav" data-offset-top="40">
	...
	<div class="container-fluid containerb">
		...
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<!-- flexigrid -->
				<div id="flextobeshippedordershavepaymanagement">
					<table id="tobeshippedordershavepaymanagement" style="display: none;"></table>
				</div>
				<div class="line-dotted"></div>
	...
	<script type="text/javascript"
		src="<%=basePath%>admin/shop/js/order/normalorderstobeshippedhavepayjs.js"></script>
