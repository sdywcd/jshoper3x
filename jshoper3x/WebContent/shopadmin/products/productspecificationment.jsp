...
<title>规格设置 &middot; jshoper</title>
...
<body data-spy="scroll" data-target=".subnav" data-offset-top="40">
	...
	<div class="navbar">
		<div class="navbar-innert">
			<a class="brand" href="#"><img
				...
				height="30" alt=""></a> <a class="brand" href="#">规格设置</a> <a
				class="brand2">所有规格设置列表</a>
		</div>
	</div>
	...
	<script type="text/javascript"
		src="<%=basePath%>admin/shop/js/products/productspecificationmentjs.js"></script>
