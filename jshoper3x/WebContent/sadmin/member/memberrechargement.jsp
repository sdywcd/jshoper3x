...
<body data-spy="scroll" data-target=".subnav" data-offset-top="40">
	...
	<div class="navbar">
		<div class="navbar-innert">
			<a class="brand" href="#"><img
				...
				height="30" alt=""></a> <a class="brand" href="#">会员充值</a> <a
				class="brand2">所有会员充值列表</a>
		</div>
	</div>
	...
	<script type="text/javascript"
		src="<%=basePath%>admin/shop/js/member/memberrechargementjs.js"></script>
