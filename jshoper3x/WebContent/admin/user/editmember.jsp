				...
				<div class="form">
					<div class="fields">
						...
						<div class="field">
							...
							<div class="input">
								<input id="newpassword" name="newpassword" value=""
									type="password" class="small" />
						...
						<div class="field">
							<div class="label">
								<label for="input-small"> 重复新密码: </label>
							</div>
							<div class="input">
						...
						<div class="field field-first">
							<div class="input">
								<div class="button highlight">
									<input type="button" id="editmember" name="editmember"
										value="修改" /> <input type="hidden" id="userid" name="userid"
										value="" />
								</div>
							</div>
						</div>
