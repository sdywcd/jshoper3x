...
<meta name="author" content="magi">
  ...
  <body data-spy="scroll" data-target=".subnav" data-offset-top="40">
			...
			<!-- 开始显示商品类型form表单 -->
				<div class="form-actions">
					<div class="form-inline">
						<span class="label label-required">选择规格类型: </span>
						...
						<span class="label label-info">请选择一个规格类型,文字类型适合于尺寸，尺码等文字可表述的规格，图片类型适合颜色及图片表示的规格，颜色类型系统提供了取色器帮助精细化色彩</span>
					</div>
					<div class="form-inline">
						<span class="label label-required">规格名称:</span>
						<input type="text" id="name" name="name"  class="small"/>
						<span class="label label-info">例如 颜色，尺码，重量</span>
					</div>	
					<div class="form-inline">
					...
					<div class="form-inline">
						...
						<input type="text" id="note" name="note"  class="medium"/>
					</div>	
					<div class="form-inline">
					...
					<div class="form-inline">
						...
						<input class="btn btn-success"  type="button" id="addparam" name="addparam" value="增加规格" />
					</div>
					</div>
    	...
    	<script type="text/javascript" src="<%=basePath%>admin/js/products/productspecificationmentjs.js"></script>
    	<script type="text/javascript" src="<%=basePath%>admin/js/plugins/farbtastic/farbtastic.js"></script>
