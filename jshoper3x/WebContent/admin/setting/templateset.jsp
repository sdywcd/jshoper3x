  ...
  <body data-spy="scroll" data-target=".subnav" data-offset-top="40">
		...
		<div id="navigation" class="navbar">
            <div class="navbar-innert">
	            ...
	            <a class="brand" href="#">模板文件和系统内容关系设定</a>
			...
			<!-- 开始显示form表单 -->
				<div class="form-actions">
					<div id="xtsy" class="select" class="form-inline">
						<span class="label label-required">系统内容: </span>
					...
					<div id="zsys" style="display: none;" class="form-inline">
						<span class="label label-required">自定义系统内容:</span>
						<input id="zsystemcontent" name="zsystemcontent" type="text"  value="" class="small"  />
					</div>	
					<div class="form-inline">
						<span class="label label-required">使用的模板文件:</span>
						<select id="templateurl" name="templateurl">
										
						</select>
					</div>	
					<div class="form-inline">
						<span class="label label-required">原标示和模板页面:</span>
						<input id="syssign" name="syssign" type="text" value="" class="large" />
					</div>	
					<div class="form-inline">
						<span class="label label-required">新标示:</span>
						<input id="sign" name="sign" type="text" value="" class="small" />
					</div>	
					<div class="form-inline">
						<span class="label label-required">静态页输出路径:</span>
						<input id="buildhtmlpath" name="buildhtmlpath" type="text" value="html/default/shop/" class="small" />
						<span class="label label-info">填写规则为：html/主题/shop/页面名称.html或者是一个目录</span> 
					</div>
					<div class="form-inline">
						<label class="label label-submit"></label>
    	...
    	<script type="text/javascript" src="<%=basePath%>admin/js/setting/templatesetmentjs.js"></script>
