  ...
  <body data-spy="scroll" data-target=".subnav" data-offset-top="40">
		...
		<div id="navigation" class="navbar">
            <div class="navbar-innert">
	            ...
	            <a class="brand" href="#">模板</a>
				<a class="brand2">编辑模板</a>
            </div>
			...
			<!-- 开始显示form表单 -->
				<div class="form-actions">
					<div class="form-inline">
						<span class="label label-required">主题选择:</span>
						<select id="templatetheme" name="templatetheme">
						</select>
						
					</div>	
					<div class="form-inline">
						<span class="label label-required">类型:</span>
					...
					<div class="form-inline">
						<span class="label label-required">模板名称: </span>
						<input id="name" name="name" type="text" value="" class="small" />
						<span class="label label-info">主题名称只能由数字和字母组成</span>
					</div>	
					<div class="form-inline">
						<span class="label label-required">模板路径:</span>
					...
					<div class="form-inline">
						...
						<input id="sign" name="sign" type="text" value="" readonly/>
						<span class="label label-info">标示必须是全局唯一的，系统通过标示来寻找静态化数据和模板的关系</span>				
					</div>	
					<div class="form-inline">
					...
					<div class="form-inline">
						...
						<textarea id="tvalue" name="tvalue" cols="100" rows="80" style="width:600px;"></textarea>
					</div>	
					<div class="form-inline">
						...
						<input  class="btn btn-success" type="submit" id="submit" name="submit" value="提交" />
    	...
    	<script type="text/javascript" src="<%=basePath%>admin/js/setting/templatementjs.js"></script>
