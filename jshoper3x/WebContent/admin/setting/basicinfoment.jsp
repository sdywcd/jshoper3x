  ...
  <body data-spy="scroll" data-target=".subnav" data-offset-top="40">
		...
		<div class="navbar">
            <div class="navbar-innert">
	            ...
	            <a class="brand" href="#">基本信息</a>
				<a class="brand2">基本信息浏览</a>
            </div>
    	...
    	<div class="container-fluid containerb">
			...
			<!-- 开始显示form表单 -->
				<div class="form-actions">
					...
					<div class="form-inline">
						<span class="label label-required">所在省份:</span>
						<input type="text" id="province" name="province" />
						<span class="label label-required">所在城市:</span>
						<input type="text" id="city" name="city" />
						<span class="label label-required">所在区/县:</span>
					...
					<div class="form-inline">
						...
						<input type="text" id="qqservice" name="qqservice"/>
					</div>
					<div class="form-inline">
						<span class="label label-required">SKYPE:</span>
						<input type="text" id="skypeservice" name="skypeservice"/>
					</div>
					<div class="form-inline">
					...
					<div class="form-inline">
						<span class="label label-required">电话:</span>
						<input type="text" id="phoneservice" name="phoneservice"/>
					</div>
					<div class="form-inline">
						<span class="label label-required">商户运营:</span>
					...
					<div class="form-inline">
						<span class="label label-required">关闭运营原因:</span>
						<input type="text" id="siteclosenotes" name="siteclosenotes"  class="medium"/>
						<span class="label label-info">请告诉大家为什么关闭运营的原因！</span>
					</div>	
					<div class="form-inline">
						<span class="label label-required">License许可状态:</span>
					...
					<div class="form-inline">
						...
						<input type="text" id="icpnum" name="icpnum"  />
