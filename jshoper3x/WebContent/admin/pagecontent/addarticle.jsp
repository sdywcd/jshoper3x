...
<body>
				...
				<div class="form">
					<div class="fields">
						<div class="field field-first">
							<div class="label">
								<label for="input-medium"> 文章标题: </label>
							</div>
							<div class="input">
						...
						<div id="addfl" class="field">
							<div class="label">
								<label for="select"> 分类选择: </label>
							</div>
							<div class="select">
								<div>
									<select id="parentId" name="parentId">

									</select> <select id="parentId1" name="parentId1">
						...
						<div id="modfl" class="field">
							<div class="label">
								<label for="select"> 所属分类: </label>
							</div>
							<div class="select">
								<div>
									<input type="text" id="parentName" name="parentName" value=""
										readonly /> <input type="button" id="modifycategory"
										name="modifycategory" value="修改" />
								</div>
							</div>
						...
						<div class="field">
							<div class="label">
								<label for="input-small"> 作者: </label>
							</div>
							<div class="input">
						...
						<div class="field">
							...
							<div class="checkboxes">
								<input id="ispublication" name="ispublication" type="checkbox"
									checked="checked" /> <label> 是 </label>
							</div>
						</div>
						<div class="field">
							<div class="label label-checkbox">
						...
						<div class="field">
							...
							<div style="margin: 0 0 0 200px;">
								<textarea id="contentvalue" name="contentvalue" cols="50"
									rows="12"
						...
						<div class="field">
							<div class="label">
								<label for="input-small"> 页面关键字: </label>
							</div>
							<div class="input">
						...
						<div class="field">
							<div class="label">
								<label for="input-small"> 页面描述: </label>
							</div>
							<div class="input">
						...
						<div class="field field-first">
							<div class="input">
								<div class="button highlight">
									<input type="hidden" id="hidposition" name="hidposition"
										value="" /> <input type="hidden" id="hidarticleid"
										name="hidarticleid" value="" /> <input type="hidden"
										id="hidarticleCategoryTid" name="articleCategoryTid" value="" />
									<input type="hidden" id="hidreadcount" name="hidreadcount"
										value="" /> <input type="button" id="submit" name="submit"
										value="提交" /> <input type="button" id="modify" name="modify"
										value="修改" style="display: none;" />
								</div>
							</div>
						</div>
					</div>
	...
	<script type="text/javascript"
		src="<%=basePath%>jshop/admin/js/articlemanagementjs.js"></script>
	<script type="text/javascript">
 		KE.show({
			id : 'contentvalue',
