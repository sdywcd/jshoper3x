				...
				<div class="form">
					<div class="fields">
						...
						<div class="field field-first">
							...
							<div class="input">
								<input type="text" id="begingtime" readonly="readonly"
									name="begingtime" class="small"
						...
						<div class="field field-first">
							...
							<div class="input">
								<input type="text" id="endingtime" readonly="readonly"
									name="endingtime" class="small"
									onfocus="WdatePicker({startDate:'%y-%M 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUserStartDate:true})" />
							...
							<div class="radios">
								<div class="radio">
									<input type=radio id="newornot" name="newornot" class="small"
										...
										name="newornot" class="small" value="0" /> <label>不是</label>
								</div>
							</div>
						</div>
						<div class="field field-first">
