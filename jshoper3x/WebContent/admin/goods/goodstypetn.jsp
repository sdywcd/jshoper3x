			...
			<!-- 开始显示商品类型form表单 -->
				<div class="form-actions">
					<div class="form-inline">
						<span class="label label-required">商品类型名称: </span>
						<input id="name" name="name" type="text" value="" class="small" />
						<span class="label label-info">给你销售的商品定义一个类型，例如手机</span>
					</div>
					<div class="form-inline">
				...
				<div id="goodstypetnparamsarea" class="form-actions">
					...
					<div class="form-inline">
						<label class="label label-submit"></label>
						<input class="btn btn-success"  type="button" id="addparam" name="addparam" value="增加参数" />
					</div>
					<div class="table">
						<table>
							<thead>
					...
					<div class="form-inline">
						<label class="label label-submit"></label>
						<input  class="btn btn-success" type="button" id="submitparam" name="submitparam" value="提交" />
						<input  class="btn btn-success" type="button" id="updateparam" name="updateparam" value="更新" style="display: none;" />
					</div>
				</div>
