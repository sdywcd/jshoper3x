				...
				<div class="form-actions">
					<div class="form-inline">
						<span class="label label-required">选择商品类型: </span>
							<select id="goodstypetn" name="goodstypetn">
									
							</select>
							
						<span class="label label-info">请选择一个商品类型并增加其属性</span>
					</div>
					<div class="form-inline">
						<label class="label label-submit"></label>
						<input class="btn btn-success"  type="button" id="addattrs" name="addattrs" value="增加属性" />
					</div>
					</div>
					...
					<div class="form-inline">
						<label class="label label-submit"></label>
						<input  class="btn btn-success" type="button" id="submitattrs" name="submitattrs" value="提交" />
						<input  class="btn btn-success" type="button" id="updateattrs" name="updateattrs" value="更新" style="display: none;" />
					</div>
				</div>
