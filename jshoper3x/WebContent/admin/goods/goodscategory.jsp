				...
				<div class="form-actions">
					...
					<div class="form-inline">
						<span class="label label-required">选择分类: </span>
							...
							<select id="parentId1" name="parentId1"></select>
						<span class="label label-info">请选择一个商品分类</span>
					</div>
					<div id="fater"  class="form-inline">
						<span class="label label-required">上级分类: </span>
						<span id="modfl"><input type="text" id="parentName" name="parentName" value="" readonly /></span>
					</div>
					<div class="form-inline">
						<span class="label label-required">分类名称:</span>
					...
					<tr>
					<td>
						<span class="label label-required">分类图标:</span>
						</td>
					<td>
					...
					<div class="form-inline">
						<span class="label label-required">静态化标示:</span>
						<input type="text" id="sign" name="sign"  class="small"/>
					</div>	
					<div class="form-inline">
					...
					<div class="form-inline">
						...
						<input type="radio" id="mobilesync" name="mobilesync" value="1"  checked="checked"/>
						<label for="radio-1">是 </label>
						<input type="radio" id="mobilesync" name="mobilesync" value="0" />
