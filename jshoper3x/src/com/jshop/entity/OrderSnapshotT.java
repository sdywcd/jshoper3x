...
/**
 * The persistent class for the order_snapshot_t database table.
 * 
 */
@Entity
@Table(name="order_snapshot_t")
@NamedQuery(name="OrderSnapshotT.findAll", query="SELECT o FROM OrderSnapshotT o")
public class OrderSnapshotT implements Serializable {
