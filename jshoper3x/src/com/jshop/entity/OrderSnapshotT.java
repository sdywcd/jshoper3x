...
/**
 * OrderSnapshotT generated by hbm2java
 */
@Entity
@Table(name = "order_snapshot_t", catalog = "jshoper3")
public class OrderSnapshotT implements java.io.Serializable {
	...
	public OrderSnapshotT(String id, String goodsid, String goodsname,
	...
	public OrderSnapshotT(String id, String cartinfoid, String cartid,
			String orderid, String goodsid, String goodsname, String userid,
			String username, int needquantity, double price, double favorable,
			...
			String state, String htmlpath, String productid, String orderTag,
			String productName, String cartTag, String memberid,
			String membername, Integer storeTag, String shopid,
	...
	@Column(name = "CARTINFOID", length = 20)
