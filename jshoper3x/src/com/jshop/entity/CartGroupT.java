...
/**
 * The persistent class for the cart_group_t database table.
 * 
 */
@Entity
@Table(name="cart_group_t")
@NamedQuery(name="CartGroupT.findAll", query="SELECT c FROM CartGroupT c")
public class CartGroupT implements Serializable {
