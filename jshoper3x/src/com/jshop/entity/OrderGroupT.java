...
/**
 * The persistent class for the order_group_t database table.
 * 
 */
@Entity
@Table(name="order_group_t")
@NamedQuery(name="OrderGroupT.findAll", query="SELECT o FROM OrderGroupT o")
public class OrderGroupT implements Serializable {
