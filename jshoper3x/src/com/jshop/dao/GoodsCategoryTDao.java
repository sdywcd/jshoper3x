...
public interface GoodsCategoryTDao extends BaseTDao<GoodsCategoryT> {
	 ...
	 * @return
	 */
	public List<GoodsCategoryT> findGoodsCategoryByGrade(String grade,
			String state);
	 ...
	 * @return
	 */
	public List<GoodsCategoryT> findAllGoodsCategoryT(final int currentPage,
	 ...
	 * @return
	 */
	public List<GoodsCategoryT> findAllGoodsCategoryTByGrade(
	 ...
	 * @return
	 */
	public GoodsCategoryT findGoodscategoryBygoodscategoryId(
	 ...
	 * @return
	 */
	public List<GoodsCategoryT> findGoodscategoryByparentId(String state,
			String parentId);
	 ...
	 * @return
	 */
	public List<GoodsCategoryT> sortAllGoodsCategoryT(final int currentPage,
