        ...
        <aside id="categories_nav">
            <nav class="left_menu">
                ...
                <ul>
                    ...
                    <li>
                        <#if sct.grade=='1'>
                        <a href="${basepath}/findSecondCategoryTGoods.action?ltypeid=${sct.goodsCategoryTid}">
                            ${sct.name}
                        </a>
                        </#if>
                    </li>
               ...
               <!--  <h3>条件筛选</h3>
                ...
                <#if (goodsattrs??)&&(goodsattrs?size>0)>
                    <#list goodsattrs as ga>
                      ...
                      <span><a style="color:#777777" onclick="searchgoodsbyattrs('${basepath}/searchGoodsByAttrs.action','${ga.goodsTypeId}','${goodscategory.goodsCategoryTid}','all','${goodscategory.grade}');"  class="curr" href="javascript:void();">全部</a></span>
                      <#list ga.attributelist?split(",") as attr>
                      <a style="color:#777777" onclick="searchgoodsbyattrs('${basepath}/searchGoodsByAttrs.action','${ga.goodsTypeId}','${goodscategory.goodsCategoryTid}','${attr}','${goodscategory.grade}');" href="javascript:void();">${attr}</a>
                      </#list>
                    </#list>
                </#if>
        ...
        <#list goods.getList() as g>
            <div class="grid_3 product">
                ...
                <div class="product_nav">
                    <a class="p_li" href="javascript:void();" onclick="addgoodstocartwithid('${g.goodsid}')">加入购物车</a>
                </div>
                <div class="cart">
