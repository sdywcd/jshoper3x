...
<title>团购商品信息管理 &middot; jshoper</title>

<!-- bootstrap-datatimepicker css -->
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/admin/js/plugins/bootstrapdatetimepicker/css/bootstrap-datetimepicker.min.css">
</head>
...
<body data-spy="scroll" data-target=".subnav" data-offset-top="40">
	...
	<div id="navigation" class="navbar">
		<div class="navbar-innert">
			<a class="brand" href="#"><img
				...
				height="30" alt=""></a> <a class="brand" href="#">团购商品信息管理 </a> <a
				class="brand2">编辑团购商品信息 </a>
		</div>
		...
		<div class="row-fluid">
			...
			<div id="mainlogic" class="span10">
				<div class="alert alert-success">
					...
					<strong>说明</strong> 请根据需要编辑团购商品信息
				</div>
				...
				<div class="form-actions">
					...
					<div class="form-inline">
						<span class="label label-required">团购标题:</span> <input type="text"
							id="groupname" name="groupname" class="medium" />
					</div>
					<div class="form-inline">
						<span class="label label-required">团购副标题:</span> <input type="text"
							id="subgroupname" name="subgroupname" class="medium" />
					</div>
					...
					<div class="form-inline">
						<span class="label label-required">团购价:</span> <input
							type="text" id="groupprice" name="groupprice"
							class="small" /> <span class="label label-info">团购价格</span>
					</div>
					<div class="form-inline">
					...
					<div class="form-inline">
						...
						<span class="label label-required">团购开始时间:</span>
						<div id="groupbegintimepicker" class="input-append date">
						    <input id="groupBeginTime" name="groupBeginTime" data-format="yyyy/MM/dd hh:mm:ss" type="text"></input>
						    <span class="add-on">
						      <i data-time-icon="icon-time" data-date-icon="icon-calendar">
						      </i>
						    </span>
						    <span class="label label-info">本商品团购的开始时间</span>
						</div>
					
					</div>
					<div class="form-inline">
					
						<span class="label label-required">团购结束时间:</span>
						<div id="groupendtimepicker" class="input-append date">
						    <input id="groupEndTime" name="groupEndTime" data-format="yyyy/MM/dd hh:mm:ss" type="text"></input>
						    <span class="add-on">
						      <i data-time-icon="icon-time" data-date-icon="icon-calendar">
						      </i>
						    </span>
						    <span class="label label-info">本商品团购的结束时间</span>
						</div>
					
					</div>
					
					<div class="form-inline">
						<span class="label label-required">商品抵扣积分额度:</span> <input type="text"
							id="groupNeedPointsLimit" name="groupNeedPointsLimit" class="small" />
					</div>
					<div class="form-inline">
						<span class="label label-required">赠送积分:</span> <input type="text"
							id="points" name="points" class="small" />
					</div>
					<div class="form-inline">
						<span class="label label-required">限购数量:</span> <input type="text"
							id="limitBuy" name="limitBuy" class="small" />
					</div>
					<div class="form-inline">
						<span class="label label-required">浏览数量:</span> <input type="text"
							id="readcount" name="readcount" class="small" />
					</div>
					<div class="form-inline">
						<span class="label label-required">评论数量:</span> <input type="text"
							id="totalcomment" name="totalcomment" class="small" />
					</div>
					<div class="form-inline">
						<span class="label label-required">虚拟订单数量:</span> <input type="text"
							id="virtualOrdersCount" name="virtualOrdersCount" class="small" />
					</div>
					...
					<div class="form-inline">
						<span class="label label-required">上架:</span> <input type="radio"
							...
							name="salestate" value="0" /> <label for="radio-2">否 </label> 
					</div>
					<div class="form-inline">
					...
					<div class="form-inline">
						<label class="label label-submit"></label> <input type="hidden"
							...
							type="hidden" id="hidgroupid" name="hidgroupid" value=""> <input
	...
	<script type="text/javascript"
		src="<%=basePath%>admin/js/goods/goodsgroupmentjs.js"></script>
	<script type="text/javascript"
	...
	<script type="text/javascript" src="<%=basePath%>admin/js/plugins/bootstrapdatetimepicker/js/bootstrap-datetimepicker.min.js"></script>
	<script type="text/javascript">
	$(function() {
	    $('#groupbegintimepicker').datetimepicker({
	      language: 'en'
	    });
	    $('#groupendtimepicker').datetimepicker({
		  language: 'en'
		});
	});
	$(function(){
